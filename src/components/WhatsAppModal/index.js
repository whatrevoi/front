...
const WhatsAppModal = ({ open, onClose, whatsAppId }) => {
  ...
  const addVariable = (variable) => {
    const selector = `[name=${textarea}]`;
    const textareaEl = document.querySelector(selector);
    if (textareaEl !== null) {
      typeInTextarea(variable, textareaEl);

      setWhatsApp((prev) => ({
        ...prev,
        [textareaEl.name]: textareaEl.value,
      }));
    }
  };
              ...
              <DialogContent dividers>
                ...
                <div>
                  <Field
                    ...
                    variant="outlined"
                    margin="dense"
                    onFocus={(e) => focusTextarea(e.target.name)}
                  />
                </div>
                <div>
                  <Field
                ...
                <div style={{ margin: "10px 0" }}>
                  <h5 style={{ margin: "2px 0" }}>Variáveis Disponíveis</h5>
                  <Chip
                    label="Saudações"
                    size="small"
